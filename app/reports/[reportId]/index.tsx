          ...
          <View style={styles.card}>
            ...
            {report.firma && (
              <>
                ...
                <Image source={{ uri: report.firma }} style={styles.previewImage} />
              </>
            )}
            ...
            {report.photo && (
              <>
                ...
                <Image source={{ uri: report.photo }} style={styles.previewImage} />
              </>
            )}
          </View>
        </ScrollView>
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: "#F1F3F8", paddingTop: Platform.OS === "android" ? StatusBar.currentHeight : 0 },
  scrollContainer: { padding: 16 },
  card: { backgroundColor: "#fff", borderRadius: 12, padding: 20, elevation: 4, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 },
